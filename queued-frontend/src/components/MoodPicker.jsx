...
export default function MoodPicker({ item, onMoodUpdate }) {
  return (
    <div className="mt-2">
      <p className="mb-1.5 text-xs uppercase tracking-widest text-slate-500">Mood when watched</p>
      <div className="flex flex-wrap gap-1.5">
        {MOODS.map((m) => (
          <button
            ...
            className={`rounded-full border px-2.5 py-0.5 text-xs font-semibold tracking-wide transition ${
              item.mood === m.value
